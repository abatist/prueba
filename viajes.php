...
mysqli_query($conexion,"insert into viajes(cod_v,n_plazas,destino,origen,precio) values 
                       ('$_REQUEST[codv]','$_REQUEST[plazas]','$_REQUEST[des])', '$_REQUEST[ori]', $_REQUEST[pre])")
  or die("Problemas en el select".mysqli_error($conexion));

mysqli_close($conexion);

echo "Se creo el viaje.";
?>
</body>
</html>