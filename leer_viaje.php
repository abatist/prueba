...
$registros=mysqli_query($conexion,"select cod_v,n_plazas,destino,origen,precio
                        from viajes where cod_v='$_REQUEST[codv]'") or
  die("Problemas en el select:".mysqli_error($conexion));

if ($reg=mysqli_fetch_array($registros))
{
  echo "Codigo: ".$reg['cod_v']."<br>";
  echo "Numero de plazas: ".$reg['n_plazas']."<br>";
