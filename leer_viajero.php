...
$registros=mysqli_query($conexion,"select cedula,nombre,direccion, telefono
                        from viajeros where cedula='$_REQUEST[ced]'") or
...
{
  echo "No existe un viajero con esta cedula.";
}
